...
% Entry-exit paths without intersections
    ...
    \draw[dashed, yellow] (0.5,5.5) -- (3.5,4.5);
    ...
    \draw[dashed, yellow] (8.5,8.5) -- (0.5,5.5);
    \draw[dashed, yellow] (0.5,4.5) -- (0.5,5.5);
    \draw[dashed, yellow] (0.5,6.5) -- (0.5,8.5);
    \draw[dashed, yellow] (1.5,5.5) -- (1.5,6.5);
    \draw[dashed, yellow] (1.5,5.5) -- (1.5,6.5);
    \draw[dashed, yellow] (2.5,3.5) -- (2.5,4.5);
    \draw[dashed, yellow] (2.5,3.5) -- (2.5,5.5);
    ...
    \draw[dashed, yellow] (7.5,3.5) -- (7.5,5.5);
